...
## Computers Are Not Magic {#computer-not-magic}
...
## What Is Operating System (OS)? {#os}
...
## How Do They Work Together {#working-together}
...
This is the exact problem we face with computers. At their core, CPU consists of billions of tiny electronic switches (just like a light switch but super tiny) that only understand two states: **on (1)** and **off (0)**. 
Humans, on the other hand, communicate using complex spoken languages, abstract concepts, and logic. Writing instructions out of billions of ones and zeros is practically impossible for a human. 
...
## Python Programming Language {#python-overview}
...
### What Can You Build with Python? {#building-with-python}
...
* [What is a computer program?](#computer-not-magic)
* [What does CPU in a computer does?](#cpu)
* [What is the largest (but also slowest) type of memory in a computer?](#storage)
* [What is an Operating System?](#os)
* [What is a programming language?](#programming-languages)
* [For what purpose is Python programming language used?](#building-with-python)
